<?php
// work_orders_print.php — generated by Generate Module
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .lines { width: 100%; border-collapse: collapse; margin-bottom: 32px; }
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Work Order Type</th><td><?= htmlspecialchars($_GET['work_order_type_name'] ?? '') ?></td></tr>
      <tr><th>Quotation</th><td><?= htmlspecialchars($_GET['quotation_ref'] ?? '') ?></td></tr>
      <tr><th>Status</th><td><?= htmlspecialchars($_GET['work_order_status_name'] ?? '') ?></td></tr>
      <tr><th>Requested Date</th><td><?= htmlspecialchars($_GET['requested_date'] ?? '') ?></td></tr>
      <tr><th>Planned Start</th><td><?= htmlspecialchars($_GET['planned_start'] ?? '') ?></td></tr>
      <tr><th>Planned End</th><td><?= htmlspecialchars($_GET['planned_end'] ?? '') ?></td></tr>
      <tr><th>Actual Start</th><td><?= htmlspecialchars($_GET['actual_start'] ?? '') ?></td></tr>
      <tr><th>Actual End</th><td><?= htmlspecialchars($_GET['actual_end'] ?? '') ?></td></tr>
      <tr><th>Description</th><td><?= htmlspecialchars($_GET['description'] ?? '') ?></td></tr>
      <tr><th>Remarks</th><td><?= htmlspecialchars($_GET['remarks'] ?? '') ?></td></tr>
    </table>
    <?php if ($lines): ?>
    <table class="lines">
      <thead>
        <tr>
          <th>#</th><th>Pickup</th><th>Delivery</th><th>Vehicle Type</th>
          <th>Planned Start</th><th>Planned End</th><th>Vehicle</th><th>Driver</th><th>Remarks</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          <td><?= $i + 1 ?></td>
          <td><?= htmlspecialchars($line['pickup_location_name'] ?? '') ?></td>
          <td><?= htmlspecialchars($line['delivery_location_name'] ?? '') ?></td>
          <td><?= htmlspecialchars($line['vehicle_type_name'] ?? '') ?></td>
          <td><?= htmlspecialchars($line['planned_start'] ?? '') ?></td>
          <td><?= htmlspecialchars($line['planned_end'] ?? '') ?></td>
          <td><?= htmlspecialchars($line['vehicle_plate'] ?? '') ?></td>
          <td><?= htmlspecialchars($line['driver_name'] ?? '') ?></td>
          <td><?= htmlspecialchars($line['remarks'] ?? '') ?></td>
        </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
