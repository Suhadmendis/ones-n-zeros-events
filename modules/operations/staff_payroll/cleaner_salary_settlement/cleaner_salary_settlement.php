<div class="app-content">
  <div class="container-fluid" id="cleaner-settlement-app">
        ...
        <table class="je-preview__table">
          ...
          <tbody>
            <tr class="je-preview__row je-preview__row--dr">
              ...
              <td class="je-preview__code">5310</td>
              <td class="je-preview__name">Cleaner Salary Expense</td>
          ...
          <div class="col-md-6">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                <input type="text" class="form-control" style="max-width:150px" v-model="form.cleaner_ref" placeholder="Ref" readonly />
                <input type="text" class="form-control" v-model="form.cleaner_name" placeholder="Cleaner Name" readonly />
                <button class="btn btn-outline-secondary" type="button" :disabled="!editing" @click="openCleanerPicker">
    ...
    <div class="modal fade" id="cleanerSettlementCleanerPickerModal" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Select Cleaner</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
          </div>
          <div class="modal-body">
            <input type="text" class="form-control mb-3" v-model="cleanerPickerSearch" placeholder="Search by name or ref..." />
            <div class="table-responsive" style="max-height:400px;overflow-y:auto;">
              <table class="table table-hover table-sm">
                ...
                <tbody>
                  <tr v-if="cleanerPickerLoading"><td colspan="4" class="text-center">Loading...</td></tr>
                  <tr v-for="c in filteredCleaners" :key="c.id" style="cursor:pointer" @click="selectCleaner(c)">
                    <td>{{ c.ref }}</td><td>{{ c.name }}</td><td>{{ c.phone }}</td>
                    <td><button class="btn btn-sm btn-primary" @click.stop="selectCleaner(c)">Select</button></td>
                  </tr>
                  <tr v-if="!cleanerPickerLoading && filteredCleaners.length===0"><td colspan="4" class="text-center text-muted">No cleaners found</td></tr>
                </tbody>
              </table>
            </div>
          </div>
    ...
    <!-- Search Modal -->
    <div class="modal fade" id="cleanerSettlementSearchModal" tabindex="-1">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Search Cleaner Salary Settlements</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
          </div>
          <div class="modal-body">
            <iframe src="/modules/operations/staff_payroll/cleaner_salary_settlement/cleaner_salary_settlement_search.php" style="width:100%;height:500px;border:none;"></iframe>
          </div>
        </div>
      </div>
    </div>
...
<script src="/modules/operations/staff_payroll/cleaner_salary_settlement/cleaner_salary_settlement.js"></script>
