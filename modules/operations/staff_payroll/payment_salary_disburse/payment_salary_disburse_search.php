...
<head>
    ...
    <title>Payment Search | Ones n Zeros ERP</title>
    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Payment / Salary Disburse Search</h3></div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="payment_salary_disburse.php">Payment</a></li>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="bi bi-list-ul me-2"></i>All Payments</h5>
                        <a href="payment_salary_disburse.php" class="btn btn-sm btn-primary"><i class="bi bi-plus"></i> New Payment</a>
                    </div>
                    <div class="card-body">
...
<script src="payment_salary_disburse_search.js"></script>
</body>
</html>
