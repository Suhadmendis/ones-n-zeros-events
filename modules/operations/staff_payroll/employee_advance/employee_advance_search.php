<?php /* modules/operations/staff_payroll/employee_advance/employee_advance_search.php — Employee picker + advance search */ ?>
...
<div class="modal fade" id="advEmployeePickerModal" tabindex="-1" aria-labelledby="advEmployeePickerLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="advEmployeePickerLabel">Select Employee</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="advEmployeePickerTable" class="table table-bordered table-hover align-middle" style="width:100%;cursor:pointer">
          <thead class="table-light">
            <tr><th>Ref</th><th>Name</th><th>Mobile</th></tr>
          </thead>
        </table>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table id="advSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
          <thead class="table-light">
            <tr><th>Ref</th><th>Employee</th><th>Date</th><th>Amount</th></tr>
          </thead>
        </table>
        </div>
      </div>
...
<script src="/modules/operations/staff_payroll/employee_advance/employee_advance_search.js"></script>
