<?php
// modules/operations/staff_payroll/employee_advance/employee_advance_print.php — Advance payment print view
...
$employee_display  = htmlspecialchars($_GET['employee_display']  ?? '');
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Employee</th><td><?= $employee_display ?></td></tr>
