<?php
// entries/driver_advance/driver_advance_print.php — Advance payment print view
...
$recipient_display = htmlspecialchars($_GET['recipient_display'] ?? '');
$date              = htmlspecialchars($_GET['date']              ?? '');
$amount            = htmlspecialchars($_GET['amount']            ?? '');

$type_label = $recipient_type === 'driver' ? 'Driver' : 'Cleaner';
?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <title>Advance Payment — <?= $ref ?></title>
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .details .total-row th, .details .total-row td { font-weight: 700; font-size: 15px; background: #e8f5e9; }
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Recipient Type</th><td><?= $type_label ?></td></tr>
      <tr><th><?= $type_label ?></th><td><?= $recipient_display ?></td></tr>
      <tr><th>Date</th><td><?= $date ?></td></tr>
      <tr class="total-row"><th>Amount</th><td>LKR <?= number_format((float)$amount, 2) ?></td></tr>
    </table>
    <div class="signatures">
      <div class="sig-block"><div class="sig-line"></div><div class="sig-label">Recipient Signature</div></div>
