<?php
// vehicle_maintenance_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Vehicle Maintenance — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Vehicle</th><td><?= htmlspecialchars($_GET['vehicle_plate'] ?? '') ?></td></tr>
      <tr><th>Maintenance Type</th><td><?= htmlspecialchars($_GET['maintenance_type_name'] ?? '') ?></td></tr>
      <tr><th>Service Provider</th><td><?= htmlspecialchars($_GET['service_provider'] ?? '') ?></td></tr>
      <tr><th>Scheduled Date</th><td><?= htmlspecialchars($_GET['scheduled_date'] ?? '') ?></td></tr>
      <tr><th>Start Date</th><td><?= htmlspecialchars($_GET['start_date'] ?? '') ?></td></tr>
      <tr><th>Completed Date</th><td><?= htmlspecialchars($_GET['completed_date'] ?? '') ?></td></tr>
      <tr><th>Odometer (km)</th><td><?= htmlspecialchars($_GET['odometer_km'] ?? '') ?></td></tr>
      <tr><th>Labour Cost</th><td><?= htmlspecialchars($_GET['labour_cost'] ?? '') ?></td></tr>
      <tr><th>Parts Cost</th><td><?= htmlspecialchars($_GET['parts_cost'] ?? '') ?></td></tr>
      <tr><th>Total Cost</th><td><?= htmlspecialchars($_GET['total_cost'] ?? '') ?></td></tr>
