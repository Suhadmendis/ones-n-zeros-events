<?php /* modules/operations/fleet_maintenance/vehicle_odometer_readings/vehicle_odometer_readings_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="vodVehiclePickerModal" tabindex="-1" aria-labelledby="vodVehiclePickerLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="vodVehiclePickerLabel">Select Vehicle</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="vodVehiclePickerTable" class="table table-bordered table-hover align-middle" style="width:100%;cursor:pointer">
...
<div class="modal fade" id="vehicleOdometerReadingsSearchModal" tabindex="-1" aria-labelledby="vehicleOdometerReadingsSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="vehicleOdometerReadingsSearchModalLabel">Vehicle Odometer Readings Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="vehicleOdometerReadingsSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/operations/fleet_maintenance/vehicle_odometer_readings/vehicle_odometer_readings_search.js"></script>