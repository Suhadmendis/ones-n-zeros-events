<?php
// vehicle_gps_print.php — generated by Generate Module
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>GPS Device</th><td><?= htmlspecialchars($_GET['gps_device_code'] ?? '') ?></td></tr>
      <tr><th>Installed Date</th><td><?= htmlspecialchars($_GET['installed_date'] ?? '') ?></td></tr>
      <tr><th>Removed Date</th><td><?= htmlspecialchars($_GET['removed_date'] ?? '') ?></td></tr>
    </table>
