<?php
// vehicle_documents_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Vehicle Documents — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Document Type</th><td><?= htmlspecialchars($_GET['document_type_name'] ?? '') ?></td></tr>
      <tr><th>Document Number</th><td><?= htmlspecialchars($_GET['document_number'] ?? '') ?></td></tr>
      <tr><th>Issue Date</th><td><?= htmlspecialchars($_GET['issue_date'] ?? '') ?></td></tr>
      <tr><th>Expiry Date</th><td><?= htmlspecialchars($_GET['expiry_date'] ?? '') ?></td></tr>
      <tr><th>Issued By</th><td><?= htmlspecialchars($_GET['issued_by'] ?? '') ?></td></tr>
      <tr><th>Attachment</th><td><?= htmlspecialchars($_GET['attachment'] ?? '') ?></td></tr>
