<?php /* entries/general_expense_entry/general_expense_entry.php — General expense entry form, included by home.php */ ?>

<div id="gex-app" class="row g-4">
  ...
  <div class="col-12">
    <div class="card card-primary card-outline mb-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
          <div class="btn-group" role="group">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#gexSearchModal">Search</button>
        ...
        <div class="row mt-2 g-4">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="gex-ref" class="col-sm-4 col-form-label">Reference No.</label>
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" class="form-control font-monospace" id="gex-ref" v-model="form.ref" disabled />
                  <span v-if="loading" class="input-group-text"><span class="spinner-border spinner-border-sm"></span></span>
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-4 col-form-label">Expense Type</label>
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" class="form-control font-monospace" id="gex-type-ref" v-model="form.expense_type_ref" placeholder="Ref…" readonly style="max-width:130px" />
                  <input type="text" class="form-control" id="gex-type-name" v-model="form.expense_type_name" placeholder="Expense type name…" readonly />
                  <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#gexTypePickerModal">
            ...
            <div class="row mb-3">
              <label for="gex-date" class="col-sm-4 col-form-label">Date</label>
              <div class="col-sm-5">
                <input type="date" class="form-control" id="gex-date" v-model="form.date" />
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="gex-amount" class="col-sm-4 col-form-label">Amount</label>
              <div class="col-sm-6">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control" id="gex-amount" placeholder="0.00" step="0.01" min="0" v-model="form.amount" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="gex-remark" class="col-sm-4 col-form-label">Remark</label>
              <div class="col-sm-8">
                <textarea class="form-control" id="gex-remark" rows="3" placeholder="Optional remark…" v-model="form.remark"></textarea>
              </div>
            </div>
          </div>
      ...
      <div class="card-footer d-flex align-items-center">
        ...
        <span class="text-success small" v-if="saved">Expense entry saved successfully.</span>
...
<?php include __DIR__ . '/general_expense_entry_search.php'; ?>

<script>const SYSTEM_NAME = '<?= htmlspecialchars($page) ?>';</script>
<script src="/modules/operations/expenses/general_expense_entry/general_expense_entry.js"></script>
