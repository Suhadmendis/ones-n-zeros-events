<?php
// entries/general_expense_entry/general_expense_entry_print.php — General expense entry print view
...
$expense_type_ref  = htmlspecialchars($_GET['expense_type_ref']  ?? '');
$expense_type_name = htmlspecialchars($_GET['expense_type_name'] ?? '');
...
<head>
  <meta charset="UTF-8" />
  <title>General Expense — <?= $ref ?></title>
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .details .total-row td { font-weight: 700; font-size: 14px; background: #f0f0f0; }
...
<body>
  ...
  <div class="page">
    ...
    <div class="doc-title">
      <h2>General Expense Voucher</h2>
      <div class="ref">Ref: <?= $ref ?></div>
    </div>
    <table class="details">
      <tr><th>Reference No.</th><td><?= $ref ?></td></tr>
      <tr><th>Expense Type Ref</th><td><?= $expense_type_ref ?></td></tr>
      <tr><th>Expense Type</th><td><?= $expense_type_name ?></td></tr>
