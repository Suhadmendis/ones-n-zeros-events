<?php
// entries/vehicle_expense_entry/vehicle_expense_entry_print.php — Vehicle expense print view
...
$vehicle_display = htmlspecialchars($_GET['vehicle_display'] ?? '');
...
<head>
  <meta charset="UTF-8" />
  <title>Vehicle Expense — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Vehicle</th><td><?= $vehicle_display ?></td></tr>
      <tr><th>Date</th><td><?= $date ?></td></tr>
      <tr><th>Category</th><td><?= $cat_label ?></td></tr>
