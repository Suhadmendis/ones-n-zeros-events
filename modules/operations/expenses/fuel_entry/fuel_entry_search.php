<?php /* entries/fuel_entry/fuel_entry_search.php — Fuel entry search modal + vehicle picker */ ?>
...
<div class="modal fade" id="fuelVehiclePickerModal" tabindex="-1" aria-labelledby="fuelVehiclePickerLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="fuelVehiclePickerLabel">Select Vehicle</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="fuelVehiclePickerTable" class="table table-bordered table-hover align-middle" style="width:100%;cursor:pointer">
...
<!-- Fuel entry search modal -->
<div class="modal fade" id="fuelSearchModal" tabindex="-1" aria-labelledby="fuelSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="fuelSearchModalLabel">Fuel Entry Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="fuelSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
          <thead class="table-light">
            <tr><th>Ref</th><th>Vehicle</th><th>Date</th><th>Liters</th><th>Rate</th><th>Total</th><th>Voucher</th></tr>
          </thead>
        </table>
        </div>
      </div>
...
<script src="/modules/operations/expenses/fuel_entry/fuel_entry_search.js"></script>
