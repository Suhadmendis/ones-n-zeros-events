<?php /* entries/fuel_entry/fuel_entry.php — Fuel entry form, included by home.php */ ?>

<div id="fuel-app" class="row g-4">
  ...
  <div class="col-12">
    <div class="card card-primary card-outline mb-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
          <div class="btn-group" role="group">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#fuelSearchModal">Search</button>
            ...
            <table class="je-preview__table">
              ...
              <tbody>
                <tr class="je-preview__row je-preview__row--dr">
                  ...
                  <td class="je-preview__code">5100</td>
                  <td class="je-preview__name">Fuel Expense</td>
        ...
        <div class="row mt-2 g-4">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="fe-ref" class="col-sm-4 col-form-label">Reference No.</label>
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" class="form-control font-monospace" id="fe-ref" v-model="form.ref" disabled />
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" class="form-control font-monospace" id="fe-vehicle-ref" v-model="form.vehicle_ref" placeholder="Ref…" readonly style="max-width:130px" />
                  <input type="text" class="form-control" id="fe-vehicle-plate" v-model="form.vehicle_plate" placeholder="Plate number…" readonly />
                  <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#fuelVehiclePickerModal">
            ...
            <div class="row mb-3">
              <label for="fe-date" class="col-sm-4 col-form-label">Date</label>
              <div class="col-sm-5">
                <input type="date" class="form-control" id="fe-date" v-model="form.date" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="fe-voucher" class="col-sm-4 col-form-label">Voucher No.</label>
              <div class="col-sm-7">
                <input type="text" class="form-control" id="fe-voucher" placeholder="Optional voucher number" v-model="form.voucher_number" />
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="fe-liters" class="col-sm-4 col-form-label">Liters</label>
              <div class="col-sm-5">
                <input type="number" class="form-control" id="fe-liters" placeholder="0.00" step="0.01" min="0" v-model="form.liters" @input="calcTotal" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="fe-rate" class="col-sm-4 col-form-label">Rate (per L)</label>
              <div class="col-sm-5">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control" id="fe-rate" placeholder="0.00" step="0.01" min="0" v-model="form.rate" @input="calcTotal" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="fe-total" class="col-sm-4 col-form-label">Total</label>
              <div class="col-sm-5">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control font-monospace" id="fe-total" v-model="form.total" disabled />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card-footer d-flex align-items-center">
        ...
        <span class="text-success small" v-if="saved">Fuel entry saved successfully.</span>
...
<?php include __DIR__ . '/fuel_entry_search.php'; ?>

<script>const SYSTEM_NAME = '<?= htmlspecialchars($page) ?>';</script>
<script src="/modules/operations/expenses/fuel_entry/fuel_entry.js"></script>
