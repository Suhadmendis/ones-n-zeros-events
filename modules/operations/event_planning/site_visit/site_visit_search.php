<?php /* modules/operations/event_planning/site_visit/site_visit_search.php — search modal; generated by Generate Module */ ?>
...
<!-- Venue picker modal -->
<div class="modal fade" id="svVenuePickerModal" tabindex="-1" aria-labelledby="svVenuePickerLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="svVenuePickerLabel">Select Venue</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="svVenuePickerTable" class="table table-bordered table-hover align-middle" style="width:100%;cursor:pointer">
...
<div class="modal fade" id="siteVisitSearchModal" tabindex="-1" aria-labelledby="siteVisitSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="siteVisitSearchModalLabel">Site Visit Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="siteVisitSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/operations/event_planning/site_visit/site_visit_search.js"></script>