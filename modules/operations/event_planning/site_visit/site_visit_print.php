<?php
// site_visit_print.php — generated by Generate Module
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Visit Date</th><td><?= htmlspecialchars($_GET['visit_date'] ?? '') ?></td></tr>
      <tr><th>Visit Time</th><td><?= htmlspecialchars($_GET['visit_time'] ?? '') ?></td></tr>
      <tr><th>Status</th><td><?= htmlspecialchars($_GET['visit_status'] ?? '') ?></td></tr>
