<?php /* modules/finance/multi_currency/multi_currency_search.php — Multi Currency search modal */ ?>
...
<div class="modal fade" id="curSearchModal" tabindex="-1" aria-labelledby="curSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="curSearchModalLabel">Currency Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="cur-search-name" class="form-control" placeholder="Search by currency name…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-code-slash"></i></span>
              <input type="text" id="cur-search-code" class="form-control" placeholder="Search by code…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="cur-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="curSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/finance/assets_budgeting/multi_currency/multi_currency_search.js"></script>
