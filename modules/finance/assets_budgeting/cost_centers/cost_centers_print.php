<?php
// modules/finance/cost_centers/cost_centers_print.php — Cost Centers print view
...
$cost_center_code = htmlspecialchars($_GET['cost_center_code'] ?? '');
$cost_center_name = htmlspecialchars($_GET['cost_center_name'] ?? '');
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Cost Center Code</th><td><?= $cost_center_code ?></td></tr>
      <tr><th>Cost Center Name</th><td><?= $cost_center_name ?></td></tr>
      <?php if ($department): ?><tr><th>Department</th><td><?= $department ?></td></tr><?php endif; ?>
      <?php if ($manager):    ?><tr><th>Manager</th><td><?= $manager ?></td></tr><?php endif; ?>
