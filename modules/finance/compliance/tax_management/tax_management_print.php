<?php
// modules/finance/tax_management/tax_management_print.php — Tax Management print view
...
$tax_name       = htmlspecialchars($_GET['tax_name']       ?? '');
$tax_code       = htmlspecialchars($_GET['tax_code']       ?? '');
$tax_type       = htmlspecialchars($_GET['tax_type']       ?? '');
$rate           = (float) ($_GET['rate']                   ?? 0);
$applicable_on  = htmlspecialchars($_GET['applicable_on']  ?? '');
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Tax Name</th><td><?= $tax_name ?></td></tr>
      <tr><th>Tax Code</th><td><?= $tax_code ?></td></tr>
      <tr><th>Tax Type</th><td><?= $tax_type ?></td></tr>
      <tr><th>Rate</th><td><?= number_format($rate, 4) ?>%</td></tr>
      <tr><th>Applicable On</th><td><?= $applicable_on ?></td></tr>
