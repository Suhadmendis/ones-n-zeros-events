<?php /* modules/finance/tax_management/tax_management_search.php — Tax Management search modal */ ?>
...
<div class="modal fade" id="taxSearchModal" tabindex="-1" aria-labelledby="taxSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="taxSearchModalLabel">Tax Management Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="tax-search-name" class="form-control" placeholder="Search by tax name…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-code-slash"></i></span>
              <input type="text" id="tax-search-code" class="form-control" placeholder="Search by tax code…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="tax-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="taxSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/finance/compliance/tax_management/tax_management_search.js"></script>
