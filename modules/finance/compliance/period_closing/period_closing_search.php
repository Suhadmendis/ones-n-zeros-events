<?php /* modules/finance/period_closing/period_closing_search.php — Period Closing search modal */ ?>
...
<div class="modal fade" id="prcSearchModal" tabindex="-1" aria-labelledby="prcSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="prcSearchModalLabel">Period Closing Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="prc-search-period" class="form-control" placeholder="Search by period…" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="prc-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="prcSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/finance/compliance/period_closing/period_closing_search.js"></script>
