<?php
// modules/finance/approval_workflow/approval_workflow_print.php — Approval Workflow print view
...
$workflow_name  = htmlspecialchars($_GET['workflow_name']  ?? '');
$module         = htmlspecialchars($_GET['module']         ?? '');
$approver_name  = htmlspecialchars($_GET['approver_name']  ?? '');
$approver_ref   = htmlspecialchars($_GET['approver_ref']   ?? '');
$min_amount     = $_GET['min_amount'] !== '' ? number_format((float)$_GET['min_amount'], 2) : '—';
$max_amount     = $_GET['max_amount'] !== '' ? number_format((float)$_GET['max_amount'], 2) : '—';
$approval_order = (int) ($_GET['approval_order'] ?? 1);
$is_mandatory   = ($_GET['is_mandatory'] ?? '0') === '1';
...
<head>
  ...
  <title>Approval Workflow — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Workflow Name</th><td><?= $workflow_name ?></td></tr>
      <tr><th>Module</th><td><?= $module ?></td></tr>
      <tr><th>Approver Name</th><td><?= $approver_name ?></td></tr>
      <?php if ($approver_ref): ?><tr><th>Approver Ref</th><td><?= $approver_ref ?></td></tr><?php endif; ?>
      <tr><th>Approval Order</th><td><?= $approval_order ?></td></tr>
      <tr><th>Mandatory</th><td><?= $is_mandatory ? 'Yes' : 'No' ?></td></tr>
      <tr><th>Min Amount</th><td><?= $min_amount ?></td></tr>
      <tr><th>Max Amount</th><td><?= $max_amount ?></td></tr>
