<?php
// modules/finance/financial_settings/financial_settings_data.php
...
function updateSetting(array $data): array {
    ...
    return supabase_patch(SB_API . 'm_financial_settings?setting_key=eq.' . urlencode($key), [
