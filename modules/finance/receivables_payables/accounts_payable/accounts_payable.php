<?php /* modules/finance/accounts_payable/accounts_payable.php — Accounts Payable form, included by home.php */ ?>

<div id="ap-app" class="row g-4">
  ...
  <div class="col-12">
    <div class="card card-primary card-outline mb-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
          <div class="btn-group" role="group">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#apSearchModal">Search</button>
        ...
        <div v-if="checkGL && financeEnabled" class="je-preview mb-4" :class="jeTotalAmount > 0 ? 'je-preview--active' : 'je-preview--empty'">
          <div class="je-preview__header">
            ...
            <span class="je-preview__badge">Saved as Draft</span>
          </div>
            ...
            <table class="je-preview__table">
              ...
              <tbody>
                ...
                <tr class="je-preview__row je-preview__row--cr">
                  ...
                  <td class="je-preview__code">2100</td>
                  <td class="je-preview__name">Accounts Payable</td>
                  <td class="je-preview__amount je-preview__amount--blank">—</td>
        ...
        <div class="row mt-2 g-4">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="ap-ref" class="col-sm-4 col-form-label">Reference No.</label>
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" class="form-control font-monospace" id="ap-ref" v-model="form.ref" disabled />
                  <span v-if="loading" class="input-group-text"><span class="spinner-border spinner-border-sm"></span></span>
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-supplier-name" class="col-sm-4 col-form-label">Supplier Name</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="ap-supplier-name" placeholder="Supplier name" v-model="form.supplier_name" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-supplier-ref" class="col-sm-4 col-form-label">Supplier Ref</label>
              <div class="col-sm-6">
                <input type="text" class="form-control font-monospace" id="ap-supplier-ref" placeholder="Optional" v-model="form.supplier_ref" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-invoice-ref" class="col-sm-4 col-form-label">Invoice Ref</label>
              <div class="col-sm-6">
                <input type="text" class="form-control font-monospace" id="ap-invoice-ref" placeholder="Optional" v-model="form.invoice_ref" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-description" class="col-sm-4 col-form-label">Description</label>
              <div class="col-sm-8">
                <textarea class="form-control" id="ap-description" rows="3" placeholder="Details" v-model="form.description"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="ap-invoice-date" class="col-sm-4 col-form-label">Invoice Date</label>
              <div class="col-sm-6">
                <input type="date" class="form-control" id="ap-invoice-date" v-model="form.invoice_date" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-due-date" class="col-sm-4 col-form-label">Due Date</label>
              <div class="col-sm-6">
                <input type="date" class="form-control" id="ap-due-date" v-model="form.due_date" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-amount" class="col-sm-4 col-form-label">Invoice Amount</label>
              <div class="col-sm-7">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control text-end" id="ap-amount" min="0" step="0.01" placeholder="0.00" v-model="form.amount" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-amount-paid" class="col-sm-4 col-form-label">Amount Paid</label>
              <div class="col-sm-7">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control text-end" id="ap-amount-paid" min="0" step="0.01" placeholder="0.00" v-model="form.amount_paid" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-sm-7">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="text" class="form-control text-end font-monospace" :value="fmtNum(balance)" disabled :class="balance > 0 ? 'text-danger' : 'text-success'" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="ap-status" class="col-sm-4 col-form-label">Status</label>
              <div class="col-sm-6">
                <select class="form-select" id="ap-status" v-model="form.status">
      ...
      <div class="card-footer d-flex align-items-center">
        ...
        <span class="text-success small" v-if="saved">Record saved successfully.</span>
...
<?php include __DIR__ . '/accounts_payable_search.php'; ?>
<script>const SYSTEM_NAME = '<?= htmlspecialchars($page) ?>';</script>
<script src="/modules/finance/receivables_payables/accounts_payable/accounts_payable.js"></script>
