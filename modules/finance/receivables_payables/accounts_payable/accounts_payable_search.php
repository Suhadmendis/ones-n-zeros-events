<?php /* modules/finance/accounts_payable/accounts_payable_search.php — AP search modal */ ?>
...
<div class="modal fade" id="apSearchModal" tabindex="-1" aria-labelledby="apSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="apSearchModalLabel">Accounts Payable Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="ap-search-supplier" class="form-control" placeholder="Search by supplier…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="ap-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="apSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/finance/receivables_payables/accounts_payable/accounts_payable_search.js"></script>
