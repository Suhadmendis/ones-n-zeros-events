<?php
// modules/finance/accounts_receivable/accounts_receivable_print.php — AR print view
...
$customer_ref  = htmlspecialchars($_GET['customer_ref']  ?? '');
...
<head>
  ...
  <title>Accounts Receivable — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Customer Ref</th><td><?= $customer_ref ?: '—' ?></td></tr>
