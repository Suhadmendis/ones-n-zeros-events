<?php /* modules/finance/accounts_receivable/accounts_receivable.php — Accounts Receivable form, included by home.php */ ?>

<div id="ar-app" class="row g-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
          <div class="btn-group" role="group">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#arSearchModal">Search</button>
        ...
        <div class="row mt-2 g-4">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="ar-ref" class="col-sm-4 col-form-label">Reference No.</label>
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" class="form-control font-monospace" id="ar-ref" v-model="form.ref" disabled />
                  <span v-if="loading" class="input-group-text"><span class="spinner-border spinner-border-sm"></span></span>
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="ar-customer-name" class="col-sm-4 col-form-label">Customer Name</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="ar-customer-name" placeholder="Customer name" v-model="form.customer_name" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ar-customer-ref" class="col-sm-4 col-form-label">Customer Ref</label>
              <div class="col-sm-6">
                <input type="text" class="form-control font-monospace" id="ar-customer-ref" placeholder="Optional" v-model="form.customer_ref" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ar-invoice-ref" class="col-sm-4 col-form-label">Invoice Ref</label>
              <div class="col-sm-6">
                <input type="text" class="form-control font-monospace" id="ar-invoice-ref" placeholder="Optional" v-model="form.invoice_ref" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ar-description" class="col-sm-4 col-form-label">Description</label>
              <div class="col-sm-8">
                <textarea class="form-control" id="ar-description" rows="3" placeholder="Details" v-model="form.description"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="ar-invoice-date" class="col-sm-4 col-form-label">Invoice Date</label>
              <div class="col-sm-6">
                <input type="date" class="form-control" id="ar-invoice-date" v-model="form.invoice_date" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ar-due-date" class="col-sm-4 col-form-label">Due Date</label>
              <div class="col-sm-6">
                <input type="date" class="form-control" id="ar-due-date" v-model="form.due_date" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="ar-amount" class="col-sm-4 col-form-label">Invoice Amount</label>
              <div class="col-sm-7">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control text-end" id="ar-amount" min="0" step="0.01" placeholder="0.00" v-model="form.amount" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="ar-amount-paid" class="col-sm-4 col-form-label">Amount Paid</label>
              <div class="col-sm-7">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control text-end" id="ar-amount-paid" min="0" step="0.01" placeholder="0.00" v-model="form.amount_paid" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              <label for="ar-status" class="col-sm-4 col-form-label">Status</label>
              <div class="col-sm-6">
                <select class="form-select" id="ar-status" v-model="form.status">
...
<?php include __DIR__ . '/accounts_receivable_search.php'; ?>
<script>const SYSTEM_NAME = '<?= htmlspecialchars($page) ?>';</script>
<script src="/modules/finance/receivables_payables/accounts_receivable/accounts_receivable.js"></script>
