<?php /* modules/finance/bank_reconciliation/bank_reconciliation_search.php — Bank Reconciliation search modal */ ?>
...
<div class="modal fade" id="bnkSearchModal" tabindex="-1" aria-labelledby="bnkSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="bnkSearchModalLabel">Bank Reconciliation Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="bnk-search-account" class="form-control" placeholder="Search by account…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-calendar3"></i></span>
              <input type="text" id="bnk-search-period" class="form-control" placeholder="Search by period…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="bnk-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="bnkSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/finance/receivables_payables/bank_reconciliation/bank_reconciliation_search.js"></script>
