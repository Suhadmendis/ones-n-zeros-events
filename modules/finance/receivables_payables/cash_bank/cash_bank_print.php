<?php
// modules/finance/cash_bank/cash_bank_print.php — Cash & Bank print view
...
$transaction_type = htmlspecialchars($_GET['transaction_type'] ?? '');
...
$status_labels = ['pending' => 'Pending', 'cleared' => 'Cleared', 'reconciled' => 'Reconciled'];
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .details td.num { text-align: right; font-family: monospace; font-weight: 700; font-size: 13px; }
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Transaction Type</th><td><?= $transaction_type ?></td></tr>
      <tr><th>Transaction Date</th><td><?= $transaction_date ?></td></tr>
      <tr><th>Reference Doc</th><td><?= $reference_doc ?: '—' ?></td></tr>
      <tr><th>Description</th><td><?= nl2br($description) ?: '—' ?></td></tr>
      <tr><th>Status</th><td><?= $status_label ?></td></tr>
      <tr><th>Amount (LKR)</th><td class="num"><?= $fmt($amount) ?></td></tr>
    </table>
