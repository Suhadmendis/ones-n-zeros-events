<?php /* modules/finance/cash_bank/cash_bank.php — Cash & Bank form, included by home.php */ ?>

<div id="cb-app" class="row g-4">
  ...
  <div class="col-12">
    <div class="card card-primary card-outline mb-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
          <div class="btn-group" role="group">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#cbSearchModal">Search</button>
        ...
        <div v-if="checkGL && financeEnabled" class="je-preview mb-4" :class="jeTotalAmount > 0 ? 'je-preview--active' : 'je-preview--empty'">
          ...
          <div v-if="jeTotalAmount > 0" class="je-preview__body">
            <table class="je-preview__table">
              ...
              <tbody>
                <template v-if="form.transaction_type === 'Deposit'">
                  <tr class="je-preview__row je-preview__row--dr">
                    <td><span class="je-preview__type je-preview__type--dr">DR</span></td>
                    <td class="je-preview__code">1110</td>
                    <td class="je-preview__name">Bank Account</td>
                ...
                <template v-else-if="form.transaction_type === 'Withdrawal'">
                  <tr class="je-preview__row je-preview__row--dr">
                    <td><span class="je-preview__type je-preview__type--dr">DR</span></td>
                    <td class="je-preview__code">1100</td>
                    <td class="je-preview__name">Cash in Hand</td>
        ...
        <div class="row mt-2 g-4">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="cb-ref" class="col-sm-4 col-form-label">Reference No.</label>
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" class="form-control font-monospace" id="cb-ref" v-model="form.ref" disabled />
                  <span v-if="loading" class="input-group-text"><span class="spinner-border spinner-border-sm"></span></span>
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="cb-account-name" class="col-sm-4 col-form-label">Account Name</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="cb-account-name" placeholder="e.g. Main Current Account" v-model="form.account_name" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="cb-account-number" class="col-sm-4 col-form-label">Account Number</label>
              <div class="col-sm-8">
                <input type="text" class="form-control font-monospace" id="cb-account-number" placeholder="Optional" v-model="form.account_number" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="cb-reference-doc" class="col-sm-4 col-form-label">Reference Doc</label>
              <div class="col-sm-8">
                <input type="text" class="form-control font-monospace" id="cb-reference-doc" placeholder="Optional" v-model="form.reference_doc" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="cb-description" class="col-sm-4 col-form-label">Description</label>
              <div class="col-sm-8">
                <textarea class="form-control" id="cb-description" rows="3" placeholder="Transaction details" v-model="form.description"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="cb-type" class="col-sm-4 col-form-label">Transaction Type</label>
              <div class="col-sm-7">
                <select class="form-select" id="cb-type" v-model="form.transaction_type">
            ...
            <div class="row mb-3">
              <label for="cb-date" class="col-sm-4 col-form-label">Transaction Date</label>
              <div class="col-sm-6">
                <input type="date" class="form-control" id="cb-date" v-model="form.transaction_date" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="cb-amount" class="col-sm-4 col-form-label">Amount</label>
              <div class="col-sm-7">
                <div class="input-group">
                  <span class="input-group-text">LKR</span>
                  <input type="number" class="form-control text-end" id="cb-amount" min="0" step="0.01" placeholder="0.00" v-model="form.amount" />
                </div>
              </div>
            </div>
            <div class="row mb-3">
              <label for="cb-status" class="col-sm-4 col-form-label">Status</label>
              <div class="col-sm-6">
                <select class="form-select" id="cb-status" v-model="form.status">
      ...
      <div class="card-footer d-flex align-items-center">
        ...
        <span class="text-success small" v-if="saved">Transaction saved successfully.</span>
...
<?php include __DIR__ . '/cash_bank_search.php'; ?>
<script>const SYSTEM_NAME = '<?= htmlspecialchars($page) ?>';</script>
<script src="/modules/finance/receivables_payables/cash_bank/cash_bank.js"></script>
