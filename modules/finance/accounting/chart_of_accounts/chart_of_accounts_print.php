<?php
// modules/finance/chart_of_accounts/chart_of_accounts_print.php — COA print view
...
$account_sub_type = htmlspecialchars($_GET['account_sub_type'] ?? '');
$parent_code      = htmlspecialchars($_GET['parent_code']      ?? '');
...
<head>
  ...
  <title>Chart of Accounts — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Account Code</th><td class="font-monospace"><?= $account_code ?></td></tr>
      <tr><th>Account Name</th><td><?= $account_name ?></td></tr>
      <tr><th>Account Type</th><td><?= $account_type ?></td></tr>
      <tr><th>Sub-Type</th><td><?= $account_sub_type ?: '—' ?></td></tr>
      <tr><th>Parent Code</th><td class="font-monospace"><?= $parent_code ?: '—' ?></td></tr>
