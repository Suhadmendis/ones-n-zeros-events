<?php /* modules/finance/general_ledger/general_ledger_search.php — GL search modal */ ?>
...
<div class="modal fade" id="glSearchModal" tabindex="-1" aria-labelledby="glSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="glSearchModalLabel">General Ledger Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="gl-search-code" class="form-control" placeholder="Search by account code…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-calendar3"></i></span>
              <input type="text" id="gl-search-period" class="form-control" placeholder="Search by period…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="gl-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="glSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/finance/accounting/general_ledger/general_ledger_search.js"></script>
