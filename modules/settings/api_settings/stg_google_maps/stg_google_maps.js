// stg_google_maps.js — Google Maps API Settings Vue app
  ...
  createApp({
    ...
    methods: {
      ...
      async update(setting, value) {
        ...
        const r = await fetch('/modules/settings/api_settings/stg_google_maps/stg_google_maps_data.php?action=update', {
          method:  'POST',
    ...
    async mounted() {
      try {
        const r    = await fetch('/modules/settings/api_settings/stg_google_maps/stg_google_maps_data.php?action=list');
