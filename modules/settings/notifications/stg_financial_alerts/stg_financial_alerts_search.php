<?php /* modules/settings/notifications/stg_financial_alerts/stg_financial_alerts_search.php — Financial Alerts search modal */ ?>
...
<div class="modal fade" id="sfaSearchModal" tabindex="-1" aria-labelledby="sfaSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="sfaSearchModalLabel">Financial Alerts Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="sfa-search-name" class="form-control" placeholder="Search by alert name…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-sliders"></i></span>
              <input type="text" id="sfa-search-condition" class="form-control" placeholder="Search by condition field…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="sfa-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="sfaSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/settings/notifications/stg_financial_alerts/stg_financial_alerts_search.js"></script>
