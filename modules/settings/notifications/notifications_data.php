<?php
// modules/settings/notifications/notifications_data.php
...
function updateSetting(array $data): array {
    ...
    return supabase_patch(SB_API . 'sys_notifications?setting_key=eq.' . urlencode($key), [
