// notifications.js — Notifications Settings Vue app
  ...
  createApp({
    ...
    methods: {
      ...
      async update(setting, value) {
        ...
        const r = await fetch('/modules/settings/notifications/notifications_data.php?action=update', {
          method:  'POST',
    ...
    async mounted() {
      try {
        const r    = await fetch('/modules/settings/notifications/notifications_data.php?action=list');
