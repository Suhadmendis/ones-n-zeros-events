<?php
// modules/settings/notifications/stg_vehicle_alerts/stg_vehicle_alerts_print.php — Vehicle Alerts print view
...
<head>
  ...
  <title>Vehicle Alert Rule — <?= $ref ?></title>
  <style>
