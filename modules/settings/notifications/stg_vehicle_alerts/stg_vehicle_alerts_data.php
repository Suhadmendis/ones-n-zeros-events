<?php
// modules/settings/notifications/stg_vehicle_alerts/stg_vehicle_alerts_data.php
...
function saveRecord(array $data): array {
    ...
    $payload['ref']        = consumeNextReference('stg_vehicle_alerts');
...
if ($action === 'next_ref') {
    echo json_encode(previewNextReference('stg_vehicle_alerts'));
} elseif ($action === 'list') {
