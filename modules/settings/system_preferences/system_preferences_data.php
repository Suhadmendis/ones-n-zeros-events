<?php
// modules/settings/system_preferences/system_preferences_data.php
...
function updateSetting(array $data): array {
    ...
    return supabase_patch(SB_API . 'sys_system_preferences?setting_key=eq.' . urlencode($key), [
