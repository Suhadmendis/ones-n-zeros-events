<?php /* modules/settings/company_settings/stg_branches/stg_branches_search.php — Branch search modal */ ?>
...
<div class="modal fade" id="brSearchModal" tabindex="-1" aria-labelledby="brSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="brSearchModalLabel">Branch Search</h5>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="br-search-name" class="form-control" placeholder="Search by branch name…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-code-slash"></i></span>
              <input type="text" id="br-search-code" class="form-control" placeholder="Search by code…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="br-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table id="brSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/settings/company_settings/stg_branches/stg_branches_search.js"></script>
