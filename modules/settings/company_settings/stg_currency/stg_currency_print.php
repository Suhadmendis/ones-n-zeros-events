<?php
// modules/settings/company_settings/stg_currency/stg_currency_print.php — Currency print view
...
$currency_code    = htmlspecialchars($_GET['currency_code']    ?? '');
$currency_name    = htmlspecialchars($_GET['currency_name']    ?? '');
$symbol           = htmlspecialchars($_GET['symbol']           ?? '');
$exchange_rate    = (float) ($_GET['exchange_rate']            ?? 1);
$is_base_currency = ($_GET['is_base_currency'] ?? '0') === '1';
$effective_date   = htmlspecialchars($_GET['effective_date']   ?? '');
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .badge-base     { color: #084298; background: #cfe2ff; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 600; }
...
<body>
  ...
  <div class="page">
    ...
    <div class="doc-title">
      <h2>Currency Record</h2>
      <div class="ref">Ref: <?= $ref ?></div>
    </div>

    <table class="details">
      <tr><th>Reference No.</th><td><?= $ref ?></td></tr>
      <tr><th>Currency Code</th><td><?= $currency_code ?></td></tr>
      <tr><th>Currency Name</th><td><?= $currency_name ?></td></tr>
      <?php if ($symbol): ?><tr><th>Symbol</th><td><?= $symbol ?></td></tr><?php endif; ?>
      <tr><th>Exchange Rate</th><td><?= number_format($exchange_rate, 6) ?></td></tr>
      <tr><th>Base Currency</th><td><?= $is_base_currency ? '<span class="badge-base">Yes</span>' : 'No' ?></td></tr>
