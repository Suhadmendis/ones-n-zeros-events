<?php
// modules/settings/company_settings/company_settings_data.php
...
function updateSetting(array $data): array {
    ...
    return supabase_patch(SB_API . 'sys_company_settings?setting_key=eq.' . urlencode($key), [
