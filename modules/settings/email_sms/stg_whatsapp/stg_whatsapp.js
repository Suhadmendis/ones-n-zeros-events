// stg_whatsapp.js — WhatsApp Business Settings Vue app
  ...
  createApp({
    ...
    methods: {
      ...
      async update(setting, value) {
        ...
        const r = await fetch('/modules/settings/email_sms/stg_whatsapp/stg_whatsapp_data.php?action=update', {
          method:  'POST',
    ...
    async mounted() {
      try {
        const r    = await fetch('/modules/settings/email_sms/stg_whatsapp/stg_whatsapp_data.php?action=list');
