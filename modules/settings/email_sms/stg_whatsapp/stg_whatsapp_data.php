<?php
// modules/settings/email_sms/stg_whatsapp/stg_whatsapp_data.php
...
const SETTING_GROUP = 'WhatsApp';

function listSettings(): array {
    return supabase_get(
        SB_API . 'sys_email_sms_settings'
...
function updateSetting(array $data): array {
    ...
    return supabase_patch(SB_API . 'sys_email_sms_settings?setting_key=eq.' . urlencode($key) . '&setting_group=eq.' . urlencode(SETTING_GROUP), [
