<?php
// modules/settings/developer_settings/developer_settings_data.php
...
function updateSetting(array $data): array {
    ...
    return supabase_patch(SB_API . 'sys_developer_settings?setting_key=eq.' . urlencode($key), [
