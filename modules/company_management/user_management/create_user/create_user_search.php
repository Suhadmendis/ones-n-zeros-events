<?php /* entries/create_user/create_user_search.php — User search modal */ ?>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="us-search-name" class="form-control" placeholder="Search by name…" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-shield"></i></span>
              <input type="text" id="us-search-role" class="form-control" placeholder="Search by role…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
        <table id="userSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/company_management/user_management/create_user/create_user_search.js"></script>
