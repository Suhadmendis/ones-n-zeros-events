<?php
// entries/create_user/create_user_print.php — User print view
...
$roles         = htmlspecialchars($_GET['roles']          ?? '');
$record_status = htmlspecialchars($_GET['record_status'] ?? '');

$status_label = match($record_status) { 'active' => 'Active', 'inactive' => 'Inactive', default => $record_status };
?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <title>User — <?= $ref ?></title>
  <style>
