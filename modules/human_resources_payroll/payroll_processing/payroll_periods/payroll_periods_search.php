<?php /* modules/human_resources_payroll/payroll_processing/payroll_periods/payroll_periods_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="ppdPayrollProfilePickerModal" tabindex="-1" aria-labelledby="ppdPayrollProfilePickerLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ppdPayrollProfilePickerLabel">Select Payroll Profile</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="ppdPayrollProfilePickerTable" class="table table-bordered table-hover align-middle" style="width:100%;cursor:pointer">
...
<div class="modal fade" id="payrollPeriodsSearchModal" tabindex="-1" aria-labelledby="payrollPeriodsSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="payrollPeriodsSearchModalLabel">Payroll Periods Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="payrollPeriodsSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/human_resources_payroll/payroll_processing/payroll_periods/payroll_periods_search.js"></script>