<?php
// payroll_periods_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Payroll Periods — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>End Date</th><td><?= htmlspecialchars($_GET['end_date'] ?? '') ?></td></tr>
      <tr><th>Payment Date</th><td><?= htmlspecialchars($_GET['payment_date'] ?? '') ?></td></tr>
      <tr><th>Period Status</th><td><?= htmlspecialchars($_GET['period_status'] ?? '') ?></td></tr>
    </table>
