<?php /* modules/human_resources_payroll/payroll_processing/payroll_runs/payroll_runs_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="prPayrollPeriodPickerModal" tabindex="-1" aria-labelledby="prPayrollPeriodPickerLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="prPayrollPeriodPickerLabel">Select Payroll Period</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="prPayrollPeriodPickerTable" class="table table-bordered table-hover align-middle" style="width:100%;cursor:pointer">
...
<div class="modal fade" id="payrollRunsSearchModal" tabindex="-1" aria-labelledby="payrollRunsSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="payrollRunsSearchModalLabel">Payroll Runs Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="payrollRunsSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/human_resources_payroll/payroll_processing/payroll_runs/payroll_runs_search.js"></script>