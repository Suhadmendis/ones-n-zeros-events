<?php
// payroll_runs_print.php — generated by Generate Module
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Run Date</th><td><?= htmlspecialchars($_GET['run_date'] ?? '') ?></td></tr>
      <tr><th>Description</th><td><?= htmlspecialchars($_GET['description'] ?? '') ?></td></tr>
      <tr><th>Payroll Status</th><td><?= htmlspecialchars($_GET['payroll_status'] ?? '') ?></td></tr>
      <tr><th>Total Gross Amount</th><td><?= htmlspecialchars($_GET['total_gross_amount'] ?? '') ?></td></tr>
      <tr><th>Total Deduction Amount</th><td><?= htmlspecialchars($_GET['total_deduction_amount'] ?? '') ?></td></tr>
      <tr><th>Total Net Amount</th><td><?= htmlspecialchars($_GET['total_net_amount'] ?? '') ?></td></tr>
