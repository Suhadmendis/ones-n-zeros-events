<?php
// payroll_inputs_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Payroll Inputs — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Employment Record</th><td><?= htmlspecialchars($_GET['employment_record_name'] ?? '') ?></td></tr>
      <tr><th>Payroll Period</th><td><?= htmlspecialchars($_GET['payroll_period_name'] ?? '') ?></td></tr>
      <tr><th>Salary Component</th><td><?= htmlspecialchars($_GET['salary_component_name'] ?? '') ?></td></tr>
      <tr><th>Quantity</th><td><?= htmlspecialchars($_GET['quantity'] ?? '') ?></td></tr>
      <tr><th>Rate</th><td><?= htmlspecialchars($_GET['rate'] ?? '') ?></td></tr>
      <tr><th>Amount</th><td><?= htmlspecialchars($_GET['amount'] ?? '') ?></td></tr>
      <tr><th>Source Type</th><td><?= htmlspecialchars($_GET['source_type'] ?? '') ?></td></tr>
      <tr><th>Source Ref</th><td><?= htmlspecialchars($_GET['source_ref'] ?? '') ?></td></tr>
      <tr><th>Remarks</th><td><?= htmlspecialchars($_GET['remarks'] ?? '') ?></td></tr>
      <tr><th>Approval Status</th><td><?= htmlspecialchars($_GET['approval_status'] ?? '') ?></td></tr>
    </table>
