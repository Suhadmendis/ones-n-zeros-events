<?php
// salary_assignments_print.php — generated by Generate Module
...
$lines   = json_decode($_GET['details'] ?? '[]', true) ?: [];
?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <title>Salary Assignments — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Effective From</th><td><?= htmlspecialchars($_GET['effective_from'] ?? '') ?></td></tr>
      <tr><th>Effective To</th><td><?= htmlspecialchars($_GET['effective_to'] ?? '') ?></td></tr>
    ...
    <table class="lines">
      ...
      <tbody>
        ...
        <tr>
          <td><?= $i + 1 ?></td>
          <td><?= htmlspecialchars($line['salary_component_name'] ?? '') ?></td>
          <td class="num"><?= htmlspecialchars((string) ($line['value'] ?? '')) ?></td>
        </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
