<?php
// payroll_profiles_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Payroll Profiles — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Pay Frequency</th><td><?= htmlspecialchars($_GET['pay_frequency'] ?? '') ?></td></tr>
      <tr><th>Pay Day</th><td><?= htmlspecialchars($_GET['pay_day'] ?? '') ?></td></tr>
      <tr><th>Proration Method</th><td><?= htmlspecialchars($_GET['proration_method'] ?? '') ?></td></tr>
      <tr><th>Fixed Divisor</th><td><?= htmlspecialchars($_GET['fixed_divisor'] ?? '') ?></td></tr>
