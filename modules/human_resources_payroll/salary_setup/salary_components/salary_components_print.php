<?php
// salary_components_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Salary Components — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Component Type</th><td><?= htmlspecialchars($_GET['component_type'] ?? '') ?></td></tr>
      <tr><th>Calculation Type</th><td><?= htmlspecialchars($_GET['calculation_type'] ?? '') ?></td></tr>
      <tr><th>Is Taxable</th><td><?= htmlspecialchars($_GET['is_taxable'] ?? '') ?></td></tr>
      <tr><th>Is Recurring</th><td><?= htmlspecialchars($_GET['is_recurring'] ?? '') ?></td></tr>
      <tr><th>Affects Gross Salary</th><td><?= htmlspecialchars($_GET['affects_gross_salary'] ?? '') ?></td></tr>
      <tr><th>Affects Net Salary</th><td><?= htmlspecialchars($_GET['affects_net_salary'] ?? '') ?></td></tr>
      <tr><th>Sort Order</th><td><?= htmlspecialchars($_GET['sort_order'] ?? '') ?></td></tr>
    </table>
