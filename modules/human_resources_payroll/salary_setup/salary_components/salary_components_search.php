<?php /* modules/human_resources_payroll/salary_setup/salary_components/salary_components_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="salaryComponentsSearchModal" tabindex="-1" aria-labelledby="salaryComponentsSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="salaryComponentsSearchModalLabel">Salary Components Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="salaryComponentsSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/human_resources_payroll/salary_setup/salary_components/salary_components_search.js"></script>