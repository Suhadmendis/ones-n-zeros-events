<?php
// freelance_crew_payment_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Freelance Crew Payment — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <div class="doc-title">
      <h2>Freelance Crew Payment</h2>
      <div class="ref">Ref: <?= $ref ?></div>
    </div>
    <table class="details">
      <tr><th>Reference No.</th><td><?= $ref ?></td></tr>
      <tr><th>Freelance Crew</th><td><?= htmlspecialchars($_GET['crew_name'] ?? '') ?></td></tr>
      <tr><th>Venue</th><td><?= htmlspecialchars($_GET['venue_name'] ?? '') ?></td></tr>
      <tr><th>Work Date</th><td><?= htmlspecialchars($_GET['work_date'] ?? '') ?></td></tr>
      <tr><th>Event Description</th><td><?= htmlspecialchars($_GET['event_description'] ?? '') ?></td></tr>
      <tr><th>Days Worked</th><td><?= htmlspecialchars($_GET['days_worked'] ?? '') ?></td></tr>
      <tr><th>Daily Rate</th><td><?= htmlspecialchars($_GET['daily_rate'] ?? '') ?></td></tr>
      <tr><th>Amount</th><td><?= htmlspecialchars($_GET['amount'] ?? '') ?></td></tr>
      <tr><th>Payment Status</th><td><?= htmlspecialchars($_GET['payment_status'] ?? '') ?></td></tr>
