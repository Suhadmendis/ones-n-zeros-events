<?php
// leave_management_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Leave Management — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Leave Type</th><td><?= htmlspecialchars($_GET['leave_type'] ?? '') ?></td></tr>
      <tr><th>Start Date</th><td><?= htmlspecialchars($_GET['start_date'] ?? '') ?></td></tr>
      <tr><th>End Date</th><td><?= htmlspecialchars($_GET['end_date'] ?? '') ?></td></tr>
      <tr><th>Status</th><td><?= htmlspecialchars($_GET['leave_status'] ?? '') ?></td></tr>
      <tr><th>Reason</th><td><?= htmlspecialchars($_GET['reason'] ?? '') ?></td></tr>
    </table>
