<?php
// attendance_print.php — generated by Generate Module
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Attendance Date</th><td><?= htmlspecialchars($_GET['attendance_date'] ?? '') ?></td></tr>
      <tr><th>Status</th><td><?= htmlspecialchars($_GET['attendance_status'] ?? '') ?></td></tr>
