// ceremony_type.js — generated by Generate Module
...
createApp({
  ...
  mounted() {
    this.fetchRefNumber();
    document.addEventListener('ceremony_type-selected', (e) => this.loadRecord(e.detail));
  },
  ...
  methods: {
    ...
    onPrint() {
      ...
      axios.get('/modules/master_files/references/ceremony_type/ceremony_type_data.php?action=exists&ref=' + encodeURIComponent(this.form.ref))
        .then(res => {
          if (!res.data.exists) {
          ...
          const params = new URLSearchParams({
            ref: this.form.ref,
        ceremony_type_name: String(this.form.ceremony_type_name ?? ''),
          });
          window.open('/modules/master_files/references/ceremony_type/ceremony_type_print.php?' + params.toString(), '_blank');
        })
    ...
    onSave() {
      ...
      const proceed = (action) => {
        axios.post('/modules/master_files/references/ceremony_type/ceremony_type_data.php?action=' + action, this.form)
          .then(() => {
            this.saved = true;
            this.onReset();
            this.fetchRefNumber();
    ...
    loadRecord(data) {
      ...
      this.form.ceremony_type_name = data.ceremony_type_name;
      this.isExisting = true;
      this.saved = false;
      this.error = '';
    },
  },
}).mount('#ceremony-type-app');