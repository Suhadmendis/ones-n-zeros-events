<?php /* modules/master_files/references/ceremony_type/ceremony_type_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="ceremonyTypeSearchModal" tabindex="-1" aria-labelledby="ceremonyTypeSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ceremonyTypeSearchModalLabel">Ceremony Type Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="ceremonyTypeSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
          <thead class="table-light">
            <tr>
              <th>Ref</th>
              <th>Ceremony Type Name</th>
            </tr>
          </thead>
        </table>
        </div>
...
<script src="/modules/master_files/references/ceremony_type/ceremony_type_search.js"></script>