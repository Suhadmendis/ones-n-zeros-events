<?php
// work_order_types_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Work Order Types — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Requires Customer</th><td><?= htmlspecialchars($_GET['requires_customer'] ?? '') ?></td></tr>
      <tr><th>Uses Vehicle</th><td><?= htmlspecialchars($_GET['uses_vehicle'] ?? '') ?></td></tr>
      <tr><th>Uses Driver</th><td><?= htmlspecialchars($_GET['uses_driver'] ?? '') ?></td></tr>
      <tr><th>Is Billable</th><td><?= htmlspecialchars($_GET['is_billable'] ?? '') ?></td></tr>
    </table>
