<?php /* modules/master_files/references/quotation_statuses/quotation_statuses_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="quotationStatusesSearchModal" tabindex="-1" aria-labelledby="quotationStatusesSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="quotationStatusesSearchModalLabel">Quotation Statuses Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="quotationStatusesSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
          <thead class="table-light">
            <tr>
              ...
              <th>Description</th>
              <th>Sort Order</th>
              <th>Is Default Status</th>
              <th>Is Final Status</th>
              <th>Can Create Work Order</th>
              <th>Color</th>
              <th>Icon</th>
            </tr>
          </thead>
...
<script src="/modules/master_files/references/quotation_statuses/quotation_statuses_search.js"></script>