<?php
// quotation_statuses_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Quotation Statuses — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Is Default Status</th><td><?= htmlspecialchars($_GET['is_default_status'] ?? '') ?></td></tr>
      <tr><th>Is Final Status</th><td><?= htmlspecialchars($_GET['is_final_status'] ?? '') ?></td></tr>
      <tr><th>Can Create Work Order</th><td><?= htmlspecialchars($_GET['can_create_work_order'] ?? '') ?></td></tr>
      <tr><th>Display Color</th><td><?= htmlspecialchars($_GET['display_color'] ?? '') ?></td></tr>
      <tr><th>Icon</th><td><?= htmlspecialchars($_GET['icon'] ?? '') ?></td></tr>
    </table>
