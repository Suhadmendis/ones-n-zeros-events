<?php
// event_type_master_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Event Type Master — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <div class="doc-title">
      <h2>Event Type Master</h2>
      <div class="ref">Ref: <?= $ref ?></div>
    </div>
    <table class="details">
      <tr><th>Reference No.</th><td><?= $ref ?></td></tr>
      <tr><th>Event Type Name</th><td><?= htmlspecialchars($_GET['event_type_name'] ?? '') ?></td></tr>
    </table>
