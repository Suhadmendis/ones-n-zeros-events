<?php
// supplier_master_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Supplier Master — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Supplier Name</th><td><?= htmlspecialchars($_GET['supplier_name'] ?? '') ?></td></tr>
      ...
      <tr><th>Supplier Category</th><td><?= htmlspecialchars($_GET['supplier_category_ref'] ?? '') ?></td></tr>
      <tr><th>Rate Card</th><td><?= htmlspecialchars($_GET['rate_card'] ?? '') ?></td></tr>
    </table>
