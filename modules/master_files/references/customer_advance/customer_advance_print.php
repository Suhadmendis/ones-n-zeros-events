<?php
// customer_advance_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Customer Advance — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Customer</th><td><?= htmlspecialchars($_GET['customer_ref'] ?? '') ?></td></tr>
      <tr><th>Booking Reference</th><td><?= htmlspecialchars($_GET['booking_reference'] ?? '') ?></td></tr>
      <tr><th>Advance Amount</th><td><?= htmlspecialchars($_GET['advance_amount'] ?? '') ?></td></tr>
      <tr><th>Advance Date</th><td><?= htmlspecialchars($_GET['advance_date'] ?? '') ?></td></tr>
      <tr><th>Payment Method</th><td><?= htmlspecialchars($_GET['payment_method'] ?? '') ?></td></tr>
      <tr><th>Notes</th><td><?= htmlspecialchars($_GET['notes'] ?? '') ?></td></tr>
    </table>
