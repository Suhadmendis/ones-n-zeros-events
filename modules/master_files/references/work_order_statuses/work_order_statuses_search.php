<?php /* modules/master_files/references/work_order_statuses/work_order_statuses_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="workOrderStatusesSearchModal" tabindex="-1" aria-labelledby="workOrderStatusesSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="workOrderStatusesSearchModalLabel">Work Order Statuses Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="workOrderStatusesSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/master_files/references/work_order_statuses/work_order_statuses_search.js"></script>