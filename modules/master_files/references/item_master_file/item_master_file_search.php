<?php /* entries/item_master_file/item_master_file_search.php — Item search modal */ ?>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="it-search-name" class="form-control" placeholder="Search by name…" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-tag"></i></span>
              <input type="text" id="it-search-category" class="form-control" placeholder="Search by category…" />
            </div>
          </div>
        </div>
        <div class="table-responsive">
        <table id="itemSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/master_files/references/item_master_file/item_master_file_search.js"></script>
