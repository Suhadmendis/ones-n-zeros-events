<?php
// entries/item_master_file/item_master_file_print.php — Item print view
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Item Name</th><td><?= $name ?></td></tr>
      <tr><th>Category</th><td><?= $category_label ?></td></tr>
      <tr><th>Unit</th><td><?= $unit ?></td></tr>
      <tr><th>Status</th><td><?= $status_label ?></td></tr>
      <?php if ($description): ?><tr><th>Description</th><td><?= $description ?></td></tr><?php endif; ?>
    </table>
