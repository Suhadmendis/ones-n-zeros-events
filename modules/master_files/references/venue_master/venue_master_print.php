<?php
// venue_master_print.php — generated by Generate Module
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Venue Name</th><td><?= htmlspecialchars($_GET['venue_name'] ?? '') ?></td></tr>
      <tr><th>Address</th><td><?= htmlspecialchars($_GET['address'] ?? '') ?></td></tr>
      <tr><th>Venue Category</th><td><?= htmlspecialchars($_GET['venue_category_ref'] ?? '') ?></td></tr>
      <tr><th>Capacity</th><td><?= htmlspecialchars($_GET['capacity'] ?? '') ?></td></tr>
      <tr><th>Layout</th><td><?= htmlspecialchars($_GET['layout'] ?? '') ?></td></tr>
      <tr><th>Contact Name</th><td><?= htmlspecialchars($_GET['contact_name'] ?? '') ?></td></tr>
      <tr><th>Contact Phone</th><td><?= htmlspecialchars($_GET['contact_phone'] ?? '') ?></td></tr>
      <tr><th>Contact Email</th><td><?= htmlspecialchars($_GET['contact_email'] ?? '') ?></td></tr>
    </table>
