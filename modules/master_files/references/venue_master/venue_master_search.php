<?php /* modules/master_files/references/venue_master/venue_master_search.php — search modal; generated by Generate Module */ ?>
...
<!-- Venue Category picker modal -->
<div class="modal fade" id="vnVenueCategoryPickerModal" tabindex="-1" aria-labelledby="vnVenueCategoryPickerLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="vnVenueCategoryPickerLabel">Select Venue Category</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="vnVenueCategoryPickerTable" class="table table-bordered table-hover align-middle" style="width:100%;cursor:pointer">
          <thead class="table-light"><tr><th>Ref</th><th>Venue Category Name</th></tr></thead>
        </table>
        </div>
      </div>
...
<div class="modal fade" id="venueMasterSearchModal" tabindex="-1" aria-labelledby="venueMasterSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="venueMasterSearchModalLabel">Venue Master Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="venueMasterSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/master_files/references/venue_master/venue_master_search.js"></script>