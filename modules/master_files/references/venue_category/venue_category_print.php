<?php
// venue_category_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Venue Category — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <div class="doc-title">
      <h2>Venue Category</h2>
      <div class="ref">Ref: <?= $ref ?></div>
    </div>
    <table class="details">
      <tr><th>Reference No.</th><td><?= $ref ?></td></tr>
      <tr><th>Venue Category Name</th><td><?= htmlspecialchars($_GET['venue_category_name'] ?? '') ?></td></tr>
    </table>
