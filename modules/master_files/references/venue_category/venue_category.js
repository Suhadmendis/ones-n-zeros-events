// venue_category.js — generated by Generate Module
...
createApp({
  ...
  mounted() {
    this.fetchRefNumber();
    document.addEventListener('venue_category-selected', (e) => this.loadRecord(e.detail));
  },
  ...
  methods: {
    ...
    onPrint() {
      ...
      axios.get('/modules/master_files/references/venue_category/venue_category_data.php?action=exists&ref=' + encodeURIComponent(this.form.ref))
        .then(res => {
          if (!res.data.exists) {
        ...
        venue_category_name: String(this.form.venue_category_name ?? ''),
          ...
          window.open('/modules/master_files/references/venue_category/venue_category_print.php?' + params.toString(), '_blank');
        })
    ...
    onSave() {
      ...
      const proceed = (action) => {
        axios.post('/modules/master_files/references/venue_category/venue_category_data.php?action=' + action, this.form)
          .then(() => {
            this.saved = true;
            this.onReset();
            this.fetchRefNumber();
    ...
    loadRecord(data) {
      ...
      this.form.venue_category_name = data.venue_category_name;
      this.isExisting = true;
      this.saved = false;
      this.error = '';
    },
  },
}).mount('#venue-category-app');