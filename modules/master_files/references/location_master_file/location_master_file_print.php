<?php
// entries/location_master_file/location_master_file_print.php — Location print view
...
<body>
  ...
  <div class="page">
    ...
    <div class="doc-title">
      <h2>Location Master File</h2>
      <div class="ref">Ref: <?= $ref ?></div>
    </div>
    <table class="details">
      <tr><th>Reference No.</th><td><?= $ref ?></td></tr>
      <tr><th>Location Name</th><td><?= $name ?></td></tr>
