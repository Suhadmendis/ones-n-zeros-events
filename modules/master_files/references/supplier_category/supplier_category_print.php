<?php
// supplier_category_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Supplier Category — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Supplier Category Name</th><td><?= htmlspecialchars($_GET['supplier_category_name'] ?? '') ?></td></tr>
    </table>
