<?php /* entries/vehicle_master_file/vehicle_master_file_search.php — Vehicle search modal, included by home.php */ ?>
  ...
  <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row g-2 mb-3">
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              ...
              <input type="text" id="vh-search-plate" class="form-control" placeholder="Search by plate…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-truck"></i></span>
              <input type="text" id="vh-search-type" class="form-control" placeholder="Search by type…" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="input-group input-group-sm">
              <span class="input-group-text"><i class="bi bi-circle"></i></span>
              <input type="text" id="vh-search-status" class="form-control" placeholder="Search by status…" />
            </div>
          </div>
        </div>
        ...
        <table id="vehicleSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="vehicleSelectBtn">Select</button>
      </div>
...
<script src="/modules/master_files/staff_fleet/vehicle_master_file/vehicle_master_file_search.js"></script>
