<?php
// entries/driver_master_file/driver_master_file_print.php — Driver print view
...
$license_number = htmlspecialchars($_GET['license_number'] ?? '');
$status         = htmlspecialchars($_GET['status']         ?? '');
$date_of_birth  = htmlspecialchars($_GET['date_of_birth']  ?? '');
$joining_date   = htmlspecialchars($_GET['joining_date']   ?? '');
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>License No.</th><td><?= $license_number ?></td></tr>
      ...
      <tr><th>Employee</th><td><?= $employee_name ?></td></tr>
      <?php endif; ?>
    </table>
