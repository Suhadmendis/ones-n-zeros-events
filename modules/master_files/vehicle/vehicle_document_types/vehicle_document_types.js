// vehicle_document_types.js — generated by Generate Module
...
createApp({
  ...
  mounted() {
    this.fetchRefNumber();
    document.addEventListener('vehicle_document_types-selected', (e) => this.loadRecord(e.detail));
  },
  ...
  methods: {
    ...
    onPrint() {
      ...
      axios.get('/modules/master_files/vehicle/vehicle_document_types/vehicle_document_types_data.php?action=exists&ref=' + encodeURIComponent(this.form.ref))
        .then(res => {
          if (!res.data.exists) {
        ...
        is_mandatory: String(this.form.is_mandatory ?? ''),
          });
          window.open('/modules/master_files/vehicle/vehicle_document_types/vehicle_document_types_print.php?' + params.toString(), '_blank');
        })
    ...
    onSave() {
      ...
      const proceed = (action) => {
        axios.post('/modules/master_files/vehicle/vehicle_document_types/vehicle_document_types_data.php?action=' + action, this.form)
          .then(() => {
            this.saved = true;
            this.onReset();
            this.fetchRefNumber();
    ...
    loadRecord(data) {
      ...
      this.form.is_mandatory = data.is_mandatory;
      this.isExisting = true;
      this.saved = false;
      this.error = '';
    },
  },
}).mount('#vehicle-document-types-app');