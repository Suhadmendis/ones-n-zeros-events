<?php
// vehicle_document_types_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Vehicle Document Types — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Is Mandatory</th><td><?= htmlspecialchars($_GET['is_mandatory'] ?? '') ?></td></tr>
    </table>
