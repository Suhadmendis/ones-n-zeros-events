<?php
// fleet_statuses_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Fleet Statuses — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Is Operational</th><td><?= htmlspecialchars($_GET['is_operational'] ?? '') ?></td></tr>
