<?php
// gps_device_print.php — generated by Generate Module
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Serial Number</th><td><?= htmlspecialchars($_GET['serial_number'] ?? '') ?></td></tr>
      <tr><th>IMEI</th><td><?= htmlspecialchars($_GET['imei'] ?? '') ?></td></tr>
      <tr><th>SIM Number</th><td><?= htmlspecialchars($_GET['sim_number'] ?? '') ?></td></tr>
      <tr><th>Manufacturer</th><td><?= htmlspecialchars($_GET['manufacturer'] ?? '') ?></td></tr>
      <tr><th>Model</th><td><?= htmlspecialchars($_GET['model'] ?? '') ?></td></tr>
    </table>
