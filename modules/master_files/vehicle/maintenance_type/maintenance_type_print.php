<?php
// maintenance_type_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Maintenance Type — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Service Interval (km)</th><td><?= htmlspecialchars($_GET['service_interval_km'] ?? '') ?></td></tr>
      <tr><th>Service Interval (days)</th><td><?= htmlspecialchars($_GET['service_interval_days'] ?? '') ?></td></tr>
    </table>
