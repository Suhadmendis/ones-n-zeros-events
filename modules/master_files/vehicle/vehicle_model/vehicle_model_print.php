<?php
// vehicle_model_print.php — generated by Generate Module
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Code</th><td><?= htmlspecialchars($_GET['code'] ?? '') ?></td></tr>
      <tr><th>Model Name</th><td><?= htmlspecialchars($_GET['model_name'] ?? '') ?></td></tr>
      <tr><th>Brand</th><td><?= htmlspecialchars($_GET['brand_name'] ?? '') ?></td></tr>
      <tr><th>Vehicle Type</th><td><?= htmlspecialchars($_GET['vehicle_type_name'] ?? '') ?></td></tr>
      <tr><th>Fuel Type</th><td><?= htmlspecialchars($_GET['fuel_type_name'] ?? '') ?></td></tr>
      <tr><th>Manufacture Start Year</th><td><?= htmlspecialchars($_GET['manufacture_start_year'] ?? '') ?></td></tr>
      <tr><th>Manufacture End Year</th><td><?= htmlspecialchars($_GET['manufacture_end_year'] ?? '') ?></td></tr>
      <tr><th>Axle Count</th><td><?= htmlspecialchars($_GET['axle_count'] ?? '') ?></td></tr>
      <tr><th>Seating Capacity</th><td><?= htmlspecialchars($_GET['seating_capacity'] ?? '') ?></td></tr>
      <tr><th>Payload Capacity (kg)</th><td><?= htmlspecialchars($_GET['payload_capacity_kg'] ?? '') ?></td></tr>
      <tr><th>Volume Capacity (m3)</th><td><?= htmlspecialchars($_GET['volume_capacity_m3'] ?? '') ?></td></tr>
      <tr><th>Fuel Tank Capacity (L)</th><td><?= htmlspecialchars($_GET['fuel_tank_capacity_l'] ?? '') ?></td></tr>
      <tr><th>Average Fuel Consumption</th><td><?= htmlspecialchars($_GET['average_fuel_consumption'] ?? '') ?></td></tr>
