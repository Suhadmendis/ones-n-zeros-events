<?php /* modules/master_files/vehicle/vehicle_brand/vehicle_brand_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="vehicleBrandSearchModal" tabindex="-1" aria-labelledby="vehicleBrandSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="vehicleBrandSearchModalLabel">Vehicle Brand Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="vehicleBrandSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/master_files/vehicle/vehicle_brand/vehicle_brand_search.js"></script>