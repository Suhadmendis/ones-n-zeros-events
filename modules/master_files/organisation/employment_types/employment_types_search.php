<?php /* modules/master_files/organisation/employment_types/employment_types_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="employmentTypesSearchModal" tabindex="-1" aria-labelledby="employmentTypesSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="employmentTypesSearchModalLabel">Employment Types Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="employmentTypesSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/master_files/organisation/employment_types/employment_types_search.js"></script>