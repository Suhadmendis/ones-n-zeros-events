<?php
// employee_master_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Employee Master — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Full Name</th><td><?= htmlspecialchars($_GET['full_name'] ?? '') ?></td></tr>
      <tr><th>Date of Birth</th><td><?= htmlspecialchars($_GET['date_of_birth'] ?? '') ?></td></tr>
      <tr><th>Phone</th><td><?= htmlspecialchars($_GET['phone'] ?? '') ?></td></tr>
      <tr><th>Mobile</th><td><?= htmlspecialchars($_GET['mobile'] ?? '') ?></td></tr>
      <tr><th>Email</th><td><?= htmlspecialchars($_GET['email'] ?? '') ?></td></tr>
      <tr><th>Address</th><td><?= htmlspecialchars($_GET['address'] ?? '') ?></td></tr>
      <tr><th>Bank Name</th><td><?= htmlspecialchars($_GET['bank_name'] ?? '') ?></td></tr>
      <tr><th>Bank Branch</th><td><?= htmlspecialchars($_GET['bank_branch'] ?? '') ?></td></tr>
      <tr><th>Bank Account Number</th><td><?= htmlspecialchars($_GET['bank_account_number'] ?? '') ?></td></tr>
      <tr><th>Tax Number</th><td><?= htmlspecialchars($_GET['tax_number'] ?? '') ?></td></tr>
