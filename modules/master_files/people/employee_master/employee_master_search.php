<?php /* modules/master_files/people/employee_master/employee_master_search.php — search modal; generated by Generate Module */ ?>
...
<div class="modal fade" id="employeeMasterSearchModal" tabindex="-1" aria-labelledby="employeeMasterSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="employeeMasterSearchModalLabel">Employee Master Search</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
        <table id="employeeMasterSearchTable" class="table table-bordered table-striped table-hover align-middle" style="width:100%;cursor:pointer">
...
<script src="/modules/master_files/people/employee_master/employee_master_search.js"></script>