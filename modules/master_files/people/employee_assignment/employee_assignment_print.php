<?php
// employee_assignment_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Employee Assignment — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Department</th><td><?= htmlspecialchars($_GET['department_name'] ?? '') ?></td></tr>
      <tr><th>Designation</th><td><?= htmlspecialchars($_GET['designation_name'] ?? '') ?></td></tr>
