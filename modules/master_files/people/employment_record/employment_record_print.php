<?php
// employment_record_print.php — generated by Generate Module
...
<head>
  <meta charset="UTF-8" />
  <title>Employment Record — <?= $ref ?></title>
  <style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="details">
      ...
      <tr><th>Employee</th><td><?= htmlspecialchars($_GET['employee_name'] ?? '') ?></td></tr>
      <tr><th>Employment Type</th><td><?= htmlspecialchars($_GET['employment_type_name'] ?? '') ?></td></tr>
      <tr><th>Payroll Profile</th><td><?= htmlspecialchars($_GET['payroll_profile_name'] ?? '') ?></td></tr>
      <tr><th>Joining Date</th><td><?= htmlspecialchars($_GET['joining_date'] ?? '') ?></td></tr>
      <tr><th>Confirmation Date</th><td><?= htmlspecialchars($_GET['confirmation_date'] ?? '') ?></td></tr>
      <tr><th>Termination Date</th><td><?= htmlspecialchars($_GET['termination_date'] ?? '') ?></td></tr>
      <tr><th>Employment Status</th><td><?= htmlspecialchars($_GET['employment_status'] ?? '') ?></td></tr>
