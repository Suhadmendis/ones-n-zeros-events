// quotation_terms_and_conditions.js — generated by Generate Module
...
createApp({
  ...
  mounted() {
    this.fetchRefNumber();
    document.addEventListener('quotation_terms_and_conditions-selected', (e) => this.loadRecord(e.detail));
  },
  ...
  methods: {
    ...
    onPrint() {
      ...
      axios.get('/modules/master_files/quotation/quotation_terms_and_conditions/quotation_terms_and_conditions_data.php?action=exists&ref=' + encodeURIComponent(this.form.ref))
        .then(res => {
          if (!res.data.exists) {
        ...
        description: String(this.form.description ?? ''),
          ...
          window.open('/modules/master_files/quotation/quotation_terms_and_conditions/quotation_terms_and_conditions_print.php?' + params.toString(), '_blank');
        })
    ...
    onSave() {
      ...
      const proceed = (action) => {
        axios.post('/modules/master_files/quotation/quotation_terms_and_conditions/quotation_terms_and_conditions_data.php?action=' + action, this.form)
          .then(() => {
            this.saved = true;
            this.onReset();
            this.fetchRefNumber();
...
}).mount('#quotation-terms-and-conditions-app');