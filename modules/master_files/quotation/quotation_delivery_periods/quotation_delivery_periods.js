// quotation_delivery_periods.js — generated by Generate Module
...
createApp({
  ...
  mounted() {
    this.fetchRefNumber();
    document.addEventListener('quotation_delivery_periods-selected', (e) => this.loadRecord(e.detail));
  },
  ...
  methods: {
    ...
    onPrint() {
      ...
      axios.get('/modules/master_files/quotation/quotation_delivery_periods/quotation_delivery_periods_data.php?action=exists&ref=' + encodeURIComponent(this.form.ref))
        .then(res => {
          if (!res.data.exists) {
        ...
        description: String(this.form.description ?? ''),
          ...
          window.open('/modules/master_files/quotation/quotation_delivery_periods/quotation_delivery_periods_print.php?' + params.toString(), '_blank');
        })
    ...
    onSave() {
      ...
      const proceed = (action) => {
        axios.post('/modules/master_files/quotation/quotation_delivery_periods/quotation_delivery_periods_data.php?action=' + action, this.form)
          .then(() => {
            this.saved = true;
            this.onReset();
            this.fetchRefNumber();
...
}).mount('#quotation-delivery-periods-app');