...
createApp({
  ...
  methods: {
    fmt: ReportUtils.fmt,
    loadDrivers() {
      axios.get('/modules/reports/staff_reports/driver_earnings/driver_earnings_data.php', { params: { action: 'list_drivers' } })
