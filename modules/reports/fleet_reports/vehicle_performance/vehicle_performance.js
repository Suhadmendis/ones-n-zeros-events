...
createApp({
  ...
  methods: {
    ...
    async loadVehicles() {
      try {
        const res = await fetch('/modules/reports/fleet_reports/vehicle_performance/vehicle_performance_data.php?action=list_vehicles');
    ...
    async load() {
      ...
      try {
        ...
        const res = await fetch(`/modules/reports/fleet_reports/vehicle_performance/vehicle_performance_data.php?${params}`);
