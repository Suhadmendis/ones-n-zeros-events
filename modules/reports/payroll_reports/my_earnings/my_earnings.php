    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="reportInfoModalLabel">
          <i class="bi bi-info-circle me-2 text-primary"></i>About: My Earnings
        </h5>
      ...
      <div class="modal-body">
        ...
        <p class="mb-3">
          The <strong>My Earnings</strong> report shows an employee their own trip earnings, day pay, and
          gross earnings for a selected month. It answers:
          <em>"How much did I earn from trips this month?"</em> — designed for individual employee
          self-service once the employee login system is live.
        </p>
        ...
        <table class="table table-sm table-bordered mb-3">
          ...
          <tbody>
            <tr><td><code>trips</code></td><td><code>driver_salary, cleaner_salary, date</code></td><td>NUMERIC, DATE</td><td>Per-trip earnings for the employee in the selected month</td></tr>
            <tr><td><code>drivers</code></td><td><code>id, name, ref</code></td><td>Various</td><td>Identifies the logged-in driver employee</td></tr>
            <tr><td><code>cleaners</code></td><td><code>id, name, ref</code></td><td>Various</td><td>Identifies the logged-in cleaner employee</td></tr>
          </tbody>
        </table>
        ...
        <ol class="mb-3">
          ...
          <li class="mb-1"><strong>Filter by month</strong> — Trip records are fetched for the selected month matching the session employee ID.</li>
          <li class="mb-1"><strong>Sum earnings</strong> — Trip earnings (driver_salary or cleaner_salary) are summed to compute gross earnings.</li>
        </ol>
...
<div id="my-earnings-app">
  <div class="alert alert-info d-flex align-items-center gap-2">
    <i class="bi bi-person-lock fs-4"></i>
    <div><strong>My Earnings</strong><br>This report is available to logged-in employees only. Employee login system coming soon.</div>
  </div>
  <div class="mt-2">
...
<script src="/modules/reports/payroll_reports/my_earnings/my_earnings.js"></script>
