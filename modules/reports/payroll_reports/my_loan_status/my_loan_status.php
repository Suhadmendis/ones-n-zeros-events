    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="reportInfoModalLabel">
          <i class="bi bi-info-circle me-2 text-primary"></i>About: My Loan Status
        </h5>
      ...
      <div class="modal-body">
        ...
        <p class="mb-3">
          The <strong>My Loan Status</strong> report shows an employee their current loan balance —
          principal borrowed, total recovered so far, and outstanding amount remaining. It answers:
          <em>"How much do I still owe on my loan?"</em> — designed for individual employee
        ...
        <table class="table table-sm table-bordered mb-3">
          ...
          <tbody>
            <tr><td><code>loans</code></td><td><code>ref, date, principal_amount, recovered_amount, status, recipient_type</code></td><td>Various</td><td>Loan record(s) for the employee showing balance and status</td></tr>
        ...
        <ol class="mb-3">
          ...
          <li class="mb-1"><strong>Fetch loan records</strong> — All loan records matching the session employee ID and type are fetched.</li>
          <li class="mb-1"><strong>Display balance</strong> — Outstanding balance = principal_amount − recovered_amount is computed and shown per loan.</li>
        </ol>
...
<div id="my-loan-status-app">
  <div class="alert alert-info d-flex align-items-center gap-2">
    <i class="bi bi-person-lock fs-4"></i>
    <div><strong>My Loan Status</strong><br>This report is available to logged-in employees only. Employee login system coming soon.</div>
  </div>
  <div class="mt-2">
...
<script src="/modules/reports/payroll_reports/my_loan_status/my_loan_status.js"></script>
