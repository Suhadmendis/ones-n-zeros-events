...
createApp({
  ...
  methods: {
    ...
    load() {
      ...
      axios.get('/modules/reports/general_reports/general_expenses_report/general_expenses_report_data.php?from='+this.dateFrom+'&to='+this.dateTo)
        .then(r => { this.rows = r.data.rows; this.summary = r.data.summary; this.ran = true; })
        .catch(() => this.error = 'Failed to load report.')
        .finally(() => this.loading = false);
    },
  },
}).mount('#gen-expenses-app');
