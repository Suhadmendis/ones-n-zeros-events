...
import { LocationMasterPage } from './location_master_file.page.js'
import { assertRecord, deleteRecord } from '../../../../helpers/db.js'
import fixture from './location_master_file.fixture.js'

test.beforeEach(async () => { await deleteRecord(fixture.dbVerify) })
test.afterEach(async ()  => { await deleteRecord(fixture.dbVerify) })

test('location master file: fill, save, and persist', async ({ page }) => {
  const form = new LocationMasterPage(page)
  await form.open()
