...
import { CustomerMasterPage } from './customer_master_file.page.js'
...
test('customer master file: fill, save, and persist', async ({ page }) => {
  const form = new CustomerMasterPage(page)
  await form.open()
