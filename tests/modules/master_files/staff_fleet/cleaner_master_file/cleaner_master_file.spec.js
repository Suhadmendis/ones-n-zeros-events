...
import { CleanerMasterPage } from './cleaner_master_file.page.js'
...
test('cleaner master file: fill, save, and persist', async ({ page }) => {
  const form = new CleanerMasterPage(page)
  await form.open()
  ...
  const fields = [
    ...fixture.fields,
    { selector: '#cl-employee-ref', value: employee.ref, column: 'employee_ref' },
  ]
